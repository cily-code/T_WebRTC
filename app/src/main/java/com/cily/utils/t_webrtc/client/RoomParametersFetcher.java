...
public class RoomParametersFetcher {
    ...
    private void roomHttpResponseParse(String response) {
        ...
        try {
            ...
            L.d(TAG, "Initiator: " + initiator);
            L.d(TAG, "WSS url: " + wssUrl);
            L.d(TAG, "WSS POST url: " + wssPostUrl);
...
//            events.onSignalingParametersError("Room IO error: " + e.toString());
    ...
    private LinkedList<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        //TODO 强制改成3478
//    url = "http://119.23.251.238:3478/v1alpha/iceconfig?key=AIzaSyAJdh2HkajseEIltlZ3SIXO02Tze9sO3NY";
        if (AsyncHttpURLConnection.HTTP_ORIGIN.equals(AsyncHttpURLConnection.DEFAULT_HTTP_ORIGIN)) {
            url = "https://networktraversal.googleapis.com/v1alpha/iceconfig?key=AIzaSyAJdh2HkajseEIltlZ3SIXO02Tze9sO3NY";
        }

        LinkedList<PeerConnection.IceServer> turnServers = new LinkedList<PeerConnection.IceServer>();
        L.d(TAG, "Request TURN from: " + url);
        HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection();
        connection.setDoOutput(true);
        connection.setRequestProperty("REFERER", AsyncHttpURLConnection.HTTP_ORIGIN);
        ...
        L.d(TAG, "TURN response: " + response);
