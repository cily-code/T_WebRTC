...
package com.cily.utils.t_webrtc.fg;
...
import com.cily.utils.t_webrtc.widget.CaptureQualityController;
...
public class CallFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (args != null) {
            String contactName = args.getString(Conf.EXTRA_ROOMID);
            contactView.setText(contactName);
            /**********************************************/
//            videoCallEnabled = args.getBoolean(Conf.EXTRA_VIDEO_CALL, true);
//            captureSliderEnabled = videoCallEnabled
//                    && args.getBoolean(Conf.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
            videoCallEnabled = SpAcUtils.videoCallEnable(getActivity(), false, null);
            captureSliderEnabled = videoCallEnabled && SpAcUtils.captureQualitySlider(getActivity(), false, null);
            /**********************************************/
        }
        if (!videoCallEnabled) {
